                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                            ...
                            @foreach ($Grades as $Grade)
                                ...
                                {{-- نذهب الى كونترولر ونكتب متغير
                                 $Grades = Grade::all(); --}}
                                    <?php $i++; ?>
                                    <td>{{ $i }}</td>
                                    <td>{{ $Grade->Name }}</td>
                                    {{-- <td> <option value="{{$Grade->id}}">{{$Grade->Name}}</option>  </td> --}}
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                {{-- {{route('Grades.update','test')}}
                                                test
                                                عشان اذا حصل مشكلة وما وصل للتعديل يظهر صفحة ال test  --}}
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input id="Name" type="text" name="Name"
                                                                   ...
                                                                   required>
                                                                    {{-- getTranslation
                                                                   عبارة عن function
                                                                    تجيب الترجمة من قاعدة البيانات باللغة المحددة اخر السطر --}}
