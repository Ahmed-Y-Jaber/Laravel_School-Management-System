                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="table-responsive mt-15">
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                {{-- Section is the name of relation ship from app\model\grade.php
                                                                    عشان يجيب كل مرحلة فيها الاقسام الخاصة بها --}}
                                                                    <tr>
                                                                        <?php $i++; ?>
                                                                        <td>{{ $i }}</td>
                                                                        <td>{{ $list_Sections->Name_Section }}</td>
                                                                        <td>{{ $list_Sections->My_classs->Name_Class }}</td>
                                                                            {{-- My_classs is the name of relation ship from app\model\Section.php --}}



                                                                        <td>    <select multiple name="teacher_id[]" class="form-control" id="exampleFormControlSelect">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                        ...
                                        <div class="col">
                                            ...
                                            <select multiple name="teacher_id[]" class="form-control" id="exampleFormControlSelect2">
                                                {{-- تم تعريف ال
                                                teacher as array becouse may be i will select multi teachers --}}
                                                @foreach($teachers as $teacher)
                                                    <option value="{{$teacher->id}}">{{$teacher->Name}}</option>
                                                {{-- يتم اظهار اسم المعلم في الشاشة وتخزين الرقم في قاعدة البيانات --}}
                                                @endforeach
                                            </select>
                                        </div>
                                        {{-- تم اضافة الشكل السابق من
                                        bootstrap --- multiple select
                                        اني اختار اكثر من حالة
                                        بضغط كنترول وبختار اكثر من حالة --}}
